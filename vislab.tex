...
\caption{Visualization of the Bode catchment (bold red lines) of the TERENO investigation based on a digital elevation model (DEM) including the intensive test sites, Rappbode reservoir (Rinke et al. 2012), Hohes Holz, Sauerbach, Selke catchment hosting the Sch\"afertal.}
\label{fig:tereno}
\end{figure}
