...
For a~detailed understanding of fluid flow behavior on the~pore-scale in
...
Figure~\ref{fig:porescale} depicts the particle visualization with
...
The authors would like to thank Thomas Kalbacher, Karsten Rinke, Benny Selle, Feng Sun and Nico Trauth for providing some of the data sets presented in the case studies. We thank Gerik Scheuermann for organizing the EnvirVis workshops. Further acknowledgments to particular project funding are referred to in the individual papers cited for the case studies presented in this article.
